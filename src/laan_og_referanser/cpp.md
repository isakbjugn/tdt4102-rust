...
```cpp
{{#include ../../cpp/laan_og_referanser/main.cpp:laan_dangling_retur}}
```
...
```cpp
{{#include ../../cpp/laan_og_referanser/main.cpp:laan_dangling_scope}}
```
...
```cpp
{{#include ../../cpp/laan_og_referanser/main.cpp:laan_vektor_invalidering}}
```
...
C++-kompilatoren sporer ikke [levetider](../ordliste.md#levetid). Den har ingen modell for hvor lenge en referanse er gyldig i forhold til dataen den peker på. Noen verktøy kan hjelpe:
