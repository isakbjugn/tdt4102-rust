...
```cpp
{{#include ../../cpp/levetider/main.cpp:levetid_dangling_retur}}
```
...
```cpp
{{#include ../../cpp/levetider/main.cpp:levetid_dangling_scope}}
```
...
```cpp
{{#include ../../cpp/levetider/main.cpp:levetid_vektor_invalidering}}
```
